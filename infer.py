...
input_name = ['question']
# output_name = ['bm25_index_selection', 'sbert_input_ids', 'sbert_attention_mask', 'token_type_ids']
output_name = ['bm25_index_selection']
...
def run_inference(sentence, model_name='bm25_retrieval', url='127.0.0.1:8000', model_version='1'):
    ...
    # input_feature = serialize_byte_tensor(np.array([sentence.encode('utf-8')], dtype=np.bytes_)).reshape(1, 1)
